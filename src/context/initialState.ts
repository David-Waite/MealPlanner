import type { AppState, Ingredient, Meal, CustomUnit } from "../types";
...
// --- Custom Units ---
// These are ingredient-specific units (e.g. "clove" for garlic).
// Each has an optional metric equivalent for unit conversion.

const MOCK_CUSTOM_UNITS: CustomUnit[] = [
  // Garlic
  {
    id: "cu_garlic_clove",
    label: "clove",
  ...
  // Canned goods
  {
    id: "cu_tomato_puree_can",
    label: "can",
    ingredientId: "ing_tomato_puree",
    metricEquivalent: 400,
    metricUnit: "g",
  },
  {
    id: "cu_tuna_can",
    ...
    metricEquivalent: 185,
    metricUnit: "g",
  },

  // Broccolini
  {
    id: "cu_broccolini_bunch",
    label: "bunch",
    ingredientId: "ing_broccolini",
    metricEquivalent: 150,
    metricUnit: "g",
  },

  // Red Onion sizing
  {
    id: "cu_red_onion_large",
    label: "large",
    ingredientId: "ing_red_onion",
    metricEquivalent: 250,
    metricUnit: "g",
  },
  {
    id: "cu_red_onion_medium",
    label: "medium",
    ingredientId: "ing_red_onion",
    metricEquivalent: 170,
    metricUnit: "g",
  },
  {
    id: "cu_red_onion_small",
    label: "small",
    ingredientId: "ing_red_onion",
    metricEquivalent: 100,
    metricUnit: "g",
  },

  // Zucchini sizing
  {
    id: "cu_zucchini_large",
    label: "large",
    ingredientId: "ing_zucchini",
    metricEquivalent: 350,
    metricUnit: "g",
  },

  // Thai chile sizing
  {
    id: "cu_thai_chile_medium",
    label: "medium",
  ...
  // Red bell pepper sizing
  {
    id: "cu_red_bell_pepper_large",
    label: "large",
    ingredientId: "ing_red_bell_pepper",
    metricEquivalent: 200,
    metricUnit: "g",
  },
  {
    id: "cu_red_bell_pepper_medium",
    label: "medium",
    ingredientId: "ing_red_bell_pepper",
    metricEquivalent: 150,
    metricUnit: "g",
  ...
  // Green bell pepper sizing
  {
    id: "cu_green_bell_pepper_medium",
    label: "medium",
  ...
  // Cucumber sizing
  {
    id: "cu_cucumber_large",
    label: "large",
    ingredientId: "ing_cucumber",
    metricEquivalent: 300,
    metricUnit: "g",
  },

  // Mixed slaw bag
  {
    id: "cu_mixed_slaw_bag",
    label: "bag",
...
const MOCK_INGREDIENTS: Ingredient[] = [
  ...
  {
    id: "ing_mahimahi_fillet",
    name: "Mahimahi Fillet",
    category: "Meat",
    perishable: true,
  },
  {
